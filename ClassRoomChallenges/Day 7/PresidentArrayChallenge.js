const presidents = [
   ...
   for(let i=0; i < presidents.length; i++){
       if (presidents[i].passed === undefined){ //silver
       console.log(presidents[i].first,presidents[i].last) //broznze
       }
       !presidents[i].passed ? console.log(presidents[i].last, presidents[i].first) : null //gold
    }    
